...
function writePackageJson(filePath) {
    if (fs_1.existsSync(filePath)) {
        ...
        json.devDependencies = Object.assign({}, json.devDependencies || {}, sampleJson.devDependencies);
        json["lint-staged"] = {
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            copyFile(path.join(path_1.getPackagePath(), "./src/resources/index.html"), path.join(currentPath, "src/templates/index.html"));
